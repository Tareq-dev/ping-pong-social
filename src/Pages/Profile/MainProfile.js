  ...
  return (
    ...
    <div className="bg-base-100 shadow-xl relative">
      <img
        ...
        alt=""
      />
      <div className="avatar online absolute top-40 left-4 md:left-8">
        <div className="w-24 md:w-28 rounded-full bg-white">
          <img
            className=""
            src={updateProfile?.picture || user?.photoURL}
            alt=""
          />
        </div>
      </div>
    ...
    <div className="flex justify-between">
      <div className="py-8 mt-8 md:ml-4">
      ...
      <Link to="/edit" className="flex justify-center items-center md:mr-8">
        <CiEdit className="border-2 p-1" size={30} />
        <span className="ml-2 md:text-md text-sm">Edit Profile</span>
      </Link>
    </div>
    <Post />
